...
import { apiLogin, apiSocialRedirect } from '@/lib/api';
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <a href="#" className="text-xs text-yellow-500 hover:text-yellow-400 transition-colors">{isRTL ? 'نسيت كلمة المرور؟' : 'Forgot password?'}</a>
              </div>
